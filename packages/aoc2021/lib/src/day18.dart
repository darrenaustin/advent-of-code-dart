...
// 
// class Day18 extends AdventDay {
//   Day18() : super(2021, 18, solution1: 4641, solution2: 4624);
// 
//   @override
//   dynamic part1() {
//     final pairs = inputDataLines().map(Pair.from);
//     Pair sum = pairs.first;
...
//   @override
//   dynamic part2() {
//     final pairs = inputDataLines().map(Pair.from).toList();
//     int maxMagnitude = 0;
