...
class Vec4 {
  ...
  Vec4 translate(num dx, num dy, num dz, num dw) => Vec4(x + dx, y + dy, z + dz,  w + dw);
  ...
  double dotProduct(Vec4 other) => x * other.x + y * other.y + z * other.z + w * other.w;

  Vec4 operator +(Vec4 other) => Vec4(x + other.x, y + other.y, z + other.z, w + other.w);

  Vec4 operator -() => Vec4(-x, -y, -z, -w);

  Vec4 operator -(Vec4 other) => Vec4(x - other.x, y - other.y, z - other.z, w - other.w);

  Vec4 operator *(num factor) => Vec4(x * factor, y * factor, z * factor, w * factor);
