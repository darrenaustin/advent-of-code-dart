  ...
  group('2020 Day 18', () {
    group('part 1', () {
      test('examples', () {
        ...
        expect(Day18().part1('5 * 9 * (7 * 3 * 3 + 9 * 3 + (8 + 6 * 4))'), 12240);
        expect(Day18().part1('((2 + 4 * 9) * (6 + 9 * 8 + 6) + 6) + 2 + 4 * 2'), 13632);
      });
    ...
    group('part 2', () {
      test('examples', () {
        ...
        expect(Day18().part2('5 * 9 * (7 * 3 * 3 + 9 * 3 + (8 + 6 * 4))'), 669060);
        expect(Day18().part2('((2 + 4 * 9) * (6 + 9 * 8 + 6) + 6) + 2 + 4 * 2'), 23340);
      });
